...
impl fmt::Display for LeapSecond {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        writeln!(f, "new_leap_second({}, {})", unix_leap_time, correction)?;
        Ok(())
    }
}
...
impl fmt::Display for MonthWeekDay {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        writeln!(f, "new_month_week_day({}, {}, {})", month, week, week_day)
    }
}
...
impl fmt::Display for Julian0WithLeap {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        writeln!(f, "new_julian0_with_leap({})", t)
    }
}
...
impl fmt::Display for Julian1WithoutLeap {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        writeln!(f, "new_julian1_without_leap({})", t)
    }
}
